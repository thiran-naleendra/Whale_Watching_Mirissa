  ...
  const values = [
    {
      icon: Shield,
      title: 'Safety First',
      description: 'Your safety is our top priority. All vessels equipped with modern safety equipment and licensed professionals.'
    },
    {
      icon: Heart,
      title: 'Eco-Conscious',
      description: 'We practice responsible whale watching, maintaining safe distances and minimizing environmental impact.'
    },
    {
      icon: Award,
      title: 'Expert Guides',
      description: 'Our experienced crew brings deep knowledge of marine biology and local waters to enhance your experience.'
    },
    {
      icon: Users,
      title: 'Guest Focused',
      description: 'Committed to creating unforgettable experiences with personalized service and attention to detail.'
    }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16 md:mb-24">
          <div>
            ...
            <div className="mt-8 md:mt-12 grid grid-cols-2 gap-4 md:gap-6">
              <div className="bg-blue-50 rounded-2xl p-6">
                ...
                <div className="text-gray-700 text-sm md:text-base">Years Operating</div>
              </div>
              <div className="bg-teal-50 rounded-2xl p-6">
                <div className="text-3xl md:text-4xl font-bold text-teal-600 mb-2">50K+</div>
                <div className="text-gray-700 text-sm md:text-base">Happy Guests</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative order-first lg:order-last">
            ...
            <div className="absolute -bottom-8 -left-8 bg-blue-600 text-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl max-w-xs">
              ...
              <div className="text-blue-100 text-xs md:text-sm leading-relaxed">Whale sighting success rate during peak season</div>
            </div>
          </div>
        </div>
