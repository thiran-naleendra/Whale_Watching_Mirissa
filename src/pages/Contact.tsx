      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to embark on your ocean adventure? Contact us to book or ask questions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 mb-16 md:mb-24">
          <div>
            <div className="bg-gradient-to-br from-blue-600 to-teal-500 rounded-2xl md:rounded-3xl p-8 md:p-12 text-white">
              <h3 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Book Your Adventure Today</h3>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-base md:text-lg">WhatsApp</div>
                    <div className="text-blue-600 text-xs md:text-sm">Instant booking & inquiries</div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-base md:text-lg">Phone</div>
                    <div className="text-blue-100 text-xs md:text-sm break-all">+94 71 312 1061</div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-base md:text-lg">Email</div>
                    <div className="text-blue-100 text-xs md:text-sm break-all">whalewatchingmirissa@gmail.com</div>
                  </div>
                </button>
              </div>
              ...
              <div className="mt-8 md:mt-10 pt-8 md:pt-10 border-t border-white/20">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <div className="font-semibold mb-1 md:mb-2 text-base md:text-lg">Location</div>
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="bg-white rounded-2xl md:rounded-3xl shadow-lg p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-6">Tour Information</h3>
              ...
              <div className="space-y-5 md:space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-semibold text-gray-900 mb-1 md:mb-2 text-sm md:text-base">Tour Schedule</h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-semibold text-gray-900 mb-1 md:mb-2 text-sm md:text-base">Best Season</h4>
                    <p className="text-gray-600 text-xs md:text-sm leading-relaxed">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-semibold text-gray-900 mb-1 md:mb-2 text-sm md:text-base">Booking</h4>
                    <p className="text-gray-600 text-xs md:text-sm leading-relaxed">
            ...
            <div className="bg-blue-50 rounded-2xl md:rounded-3xl p-6 md:p-8">
              <h3 className="text-lg md:text-2xl font-bold text-gray-900 mb-4 md:mb-6">What to Bring</h3>
              <ul className="space-y-3 md:space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-start">
                    <svg className="w-4 h-4 md:w-5 md:h-5 text-teal-500 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-teal-500 rounded-2xl md:rounded-3xl p-8 md:p-12 text-center text-white">
          <h3 className="text-2xl md:text-3xl font-bold mb-4">Ready for the Adventure of a Lifetime?</h3>
          <p className="text-base md:text-lg text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
            Don't miss your chance to witness the magnificent blue whales and dolphins. Book your tour today!
          </p>
          <button
            onClick={handleWhatsApp}
