import { Mountain, MapPin, Camera, Palmtree, MessageCircle } from 'lucide-react';

const Tours = () => {
  const handleBookNow = (tourName: string) => {
    window.open(`https://wa.me/94713121061?text=I%27m%20interested%20in%20booking%20${encodeURIComponent(tourName)}`, '_blank');
  };
  ...
  const tours = [
    {
      ...
      description: 'Discover Sri Lanka\'s incredible wildlife including leopards in Yala National Park and elephants.',
      highlights: [
    ...
    },
    {
      ...
      description: 'Explore the magnificent rock fortress of Sigiriya and UNESCO World Heritage Sites.',
      highlights: [
    ...
    },
    {
      ...
      description: 'Relax on stunning coastline with crystal-clear waters and golden sands.',
      highlights: [
    ...
    },
    {
      ...
      description: 'Visit the Temple of the Tooth and explore traditional Kandyan culture.',
      highlights: [
      ...
      <section className="relative h-[80vh] md:h-[90vh] flex items-center justify-center text-center bg-cover bg-center" style={{ backgroundImage: "url('https://images.pexels.com/photos/2403209/pexels-photo-2403209.jpeg')" }}>
        ...
        <div className="relative z-10 max-w-3xl px-4">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-white mb-8">
            Adventure, culture, and nature await. Discover unforgettable experiences with our curated tours.
          </p>
          <button
            ...
            return (
              ...
              >
                ...
                <div className="p-6 md:p-8 flex-1 flex flex-col">
                  ...
                  <div className="mb-6">
                    <h4 className="font-semibold text-gray-900 mb-3 text-sm md:text-base">Tour Highlights:</h4>
                    <ul className="space-y-2">
                      {tour.highlights.map((highlight, idx) => (
                        <li key={idx} className="flex items-start text-xs md:text-sm">
                          <svg className="w-4 h-4 md:w-5 md:h-5 text-teal-500 mr-2 md:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
